...
describe('terraform-builder', () => {
  ...
  let classUnderTest: AnsibleBuilderApi;
  ...
  beforeEach(async () => {
    ...
    classUnderTest = Container.get(AnsibleBuilderNew);
  })

  describe('given buildAnsibleComponent()', () => {
    describe('when BOM module references a dependent module alias', () => {
      ...
      test('then use the module defined by the alias', async () => {
        const result: AnsibleComponentModel = await classUnderTest.buildAnsibleComponent(selectedModules, catalog);
    ...
    describe('when BOM module references variables', () => {
      ...
      test('then apply the variables to the resulting terraform module', async () => {
        const result = await classUnderTest.buildAnsibleComponent(selectedModules, catalog);
